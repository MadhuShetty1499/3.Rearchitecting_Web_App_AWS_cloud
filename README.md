...
Subsequently, I restructured the application using cloud-native services, unlocking several key advantages. We enhanced scalability, optimized costs, bolstered resilience, and achieved greater development speed and security. This journey underscores the potential of cloud-native solutions and the power of DevOps and automation in shaping the future of modern web applications.
  ...
  ![Architecture](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/Architecture.png)
  ...
  5. Create an ACM certificate
    ...
    ![ACM](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/ACM.png)
    ...
    ![DNS_entry](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/DNS%20entry.png)
   
  ### Detailed steps:
  - Create key pair (pem):
    ![keypair](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/keypair.png)
  ...
  - Create backend security group:
    ...
    ![SG](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/SG.png)
  ...
  - Create RDS:
    ...
    ![RDS](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/RDS.png)
  ...
  - Create Elasticache:
    ...
    ![memcache](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/memcache.png)
  ...
  - Create AmazonMQ:
    ...
    ![rabbitmq](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/rabbitmq.png)
  ...
  - DB Initialization:
    ...
    ![mysqlSG](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/mysqlSG.png)
    ...
    + Clone the source code - `$ sudo apt install git -y`
                            - `$ git clone https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud.git`
  ...
  - Create Elastic Beanstalk:
    ...
    ![BeanstalkRole](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/BeanstalkRole.png)
    ...
    ![Beanstalk](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/Beanstalk.png)
  ...
  - Build and Deploy Artifact:
    + Clone the source code to local - `$ git clone https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud.git`
    + Edit application.properties file - (PATH: 3.Rearchitecting_Web_App_AWS_cloud/src/main/resources/application.properties)
      ...
      5. Save it.
    ![application](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/application.png)
    ...
    ![BeanstalkENV](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/BeanstalkENV.png)
  ...
  - Create CloudFront:
    ...
    ![cloudfront](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/cloudfront.png)
  
  - Validate:
    + verify in the browser using cloudfront domain name.
    + Login as admin_vp (username and password both) check the services
    ![WebApp](https://github.com/MadhuShetty1499/3.Rearchitecting_Web_App_AWS_cloud/blob/main/Images/web%20app.png)
